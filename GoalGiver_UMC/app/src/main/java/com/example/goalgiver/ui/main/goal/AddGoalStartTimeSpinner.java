...
public class AddGoalStartTimeSpinner extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_goal_start_time_spinner);

        startTimePicker = findViewById(R.id.start_timePicker);
        st_cancelButton = findViewById(R.id.add_goal_start_cencel);
        st_completeButton = findViewById(R.id.add_goal_start_choose_complete);
